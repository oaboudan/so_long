...
/*   Updated: 2023/04/17 18:02:32 by oaboudan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	import_img_assets(t_vars *vars)
{
	...
	vars->bw = mlx_xpm_file_to_image(vars->mlx, "././textures/bw.xpm", &x, &y);
	push_img_back(&vars->img_str, ft_new_img(vars->bw));
	vars->fs = mlx_xpm_file_to_image(vars->mlx, "././textures/fs.xpm", &x, &y);
